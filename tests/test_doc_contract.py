...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_counts_the_tests_that_need_a_browser",
    "COMMAND": "test_every_documented_command_exits_the_way_the_readme_says",
    "OUTPUT": "test_the_committed_demo_output_still_matches_a_live_run",
...
def _resolves(claim: str) -> bool:
    ...
    `questz/thing.py` because that is the import path a reader types, and the file is at
    `src/questz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
