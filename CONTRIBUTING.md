...
```bash
git clone https://github.com/PNX89/QUESTZ.git && cd QUESTZ
uv sync --locked --dev
...
uv run pytest -m e2e --tracing=retain-on-failure
```
...
https://pnx89.github.io/QUESTZ, come from a real run whose output is committed under
